...
async function main() {
    try {
        ...
        const secret = await ca.register({ affiliation: `org${org}.department1`, enrollmentID: userString, role: 'client' }, adminIdentity);
        const enrollment = await ca.enroll({ enrollmentID: userString, enrollmentSecret: secret });
