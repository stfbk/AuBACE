...
var store_path = path.join(os.homedir(), '.hfc-key-store3');
...
Fabric_Client.newDefaultKeyValueStore({ path: store_path
    ...
    fabric_ca_client = new Fabric_CA_Client('https://localhost:9054', tlsOptions , 'ca_org3.example.com', crypto_suite);
    ...
    console.log('Assigned the admin3 user to the fabric client ::' + admin_user.toString());
}).catch((err) => {
