...
async function main() {
    try {
        ...
        const identity = X509WalletMixin.createIdentity(`Org${org}MSP`, enrollment.certificate, enrollment.key.toBytes());
        await wallet.import('admin', identity);
        console.log(`Successfully enrolled admin user "admin" and imported it into the org${org} wallet`);
